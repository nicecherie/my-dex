...
export const TABLE_SCHEMAS = {
  ...
  // 池子信息表
  // 池子地址、token0、token1、交易费、tick_spacing
  // 创建时间、创建区块、更新时间、
  pools: `
...
export async function initializeDatabase() {
  try {
    ...
    // 初始化扫描状态
    const contracts = [
      '0x5FbDB2315678afecb367f032d93F642f64180aa3', // POOL_MANAGER
      '0xe7f1725E7734CE288F8367e1Bb143E90bb3F0512', // POSITION_MANAGER
      '0x9fE46736679d2D9a65F0992F2272dE9f3c7fa6e0' // SWAP_ROUTER
    ]
